...
return [
    ...
    'client'   => [
        'model'      => [
            ...
            'appends'       => ['picture'],
            'fillable'      => ['id', 'name', 'email', 'password', 'api_token', 'remember_token', 'sex', 'dob','cpfcnpj', 'mobile', 'phone', 'billingAddres1', 'billingAddres2', 'city', 'postcode', 'state', 'country', 'photo', 'web', 'status', 'upload_folder', 'deleted_at', 'created_at', 'updated_at'],
            'translatables' => [],
